...
public class AnimatedSprite extends Sprite {
	...
	public void collide(Platformer platform){
		if(this.collidesWith(platform)){
			if((this.getPositionX()>platform.getPositionX() || this.getPositionX()+this.getUnscaledWidth()>platform.getPositionX()) && this.getPositionX()<platform.getPositionX()+platform.getUnscaledWidth()){
